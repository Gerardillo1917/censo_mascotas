        ...
        <div class="container">
            <div class="d-flex flex-column flex-lg-row align-items-center justify-content-between">
                <a href="<?php echo BASE_URL; ?>/index.php" class="header-logo">
                    ...
                    <span class="header-title">Censo de Mascotas</span>
                </a>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark header-nav p-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarHeader">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo BASE_URL; ?>/agregar_tutor.php">
                                    <i class="bi bi-person-plus me-1"></i> Agregar
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo BASE_URL; ?>/buscar.php">
