    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET' && (isset($_GET['nombre']) || isset($_GET['apellido_paterno']) || isset($_GET['apellido_materno']) || isset($_GET['telefono']) || isset($_GET['email']) || isset($_GET['calle']) || isset($_GET['numero_exterior']) || isset($_GET['colonia']) || isset($_GET['codigo_postal']))) {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '</td>
                        <td>
                            <a href="' . BASE_URL . '/perfil.php?id=' . ($row['id_tutor'] ?? '') . '" class="btn btn-sm btn-info view-profile-btn"><i class="bi bi-eye me-1"></i>Ver Perfil</a>
                            <a href="' . BASE_URL . '/agregar_mascota.php?tutor=' . ($row['id_tutor'] ?? '') . '" class="btn btn-sm btn-success add-pet-btn mt-2 mt-md-0 ms-md-2"><i class="bi bi-plus-circle me-1"></i>Añadir Mascota</a>
                        </td>
                      </tr>';
            }
...
<style>
    ...
    .search-card-header {
        ...
        color: var(--search-white-text); /* ¡CORREGIDO: Texto en blanco! */
    ...
    .search-card-header h4 {
        margin-bottom: 0;
        color: inherit; /* Hereda el color blanco del padre .search-card-header */
    }
    ...
    .search-form .form-control:focus {
        border-color: rgba(139, 1, 128, 0.5); /* Color del focus basado en primary */
    ...
    .search-btn:hover {
        background-color: var(--search-secondary-color); /* Un color diferente al pasar el mouse */
    ...
    .search-results-table td {
        ...
        border-color: var(--search-border-color); /* Borde entre celdas */
    }
    ...
    @media (max-width: 767.98px) {
        .search-results-table td:last-child {
            ...
            gap: 5px; /* Espacio entre botones apilados */
        }
    }
</style>
